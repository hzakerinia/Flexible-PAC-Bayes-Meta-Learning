...
call(['python', 'PriorMetaLearning/main_Meta_Bayes.py',
      '--run-name', 'PermutedLabels_{}_TrTask_{}_TeTask_{}_TrSample_{}_TeSample_{}_TrEpoch_{}_TeEpoch_{}_Comp_{}_Seed'.format(
          n_train_tasks, test_tasks, train_samples, test_samples,
